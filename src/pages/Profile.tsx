        ...
        >
          {showSuccess && (
            ...
            >
              ...
              <p className="text-sm font-bold text-emerald-900 tracking-tight">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="pr-1 sm:pr-4">
                  ...
                  <p className="text-[10px] sm:text-xs text-white/80 font-medium">
                    Add gender and age to get started.
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-md shadow-slate-200/30 overflow-hidden w-full">
            <button
              ...
              className={`w-full flex items-center justify-between p-4 sm:p-6 transition-colors ${
                !isEditing ? "hover:bg-slate-50/50" : "cursor-default"
              }`}
            >
              <div className="flex items-center gap-4 sm:gap-5">
                <div className="w-1 h-5 sm:w-1.5 sm:h-6 bg-primary-500 rounded-full" />
                <div className="text-left">
                  <h3 className="text-xs sm:text-sm font-bold text-slate-900 capitalize tracking-normal">
                    Public Identity
                  </h3>
                  {!isIdentityExpanded && isProfileComplete && !isEditing && (
                    <p className="text-[10px] text-slate-400 font-bold capitalize mt-0.5 tracking-wider">
              ...
              {!isEditing && (
                <div
                  className={`p-2 sm:p-2.5 rounded-xl bg-slate-50 text-slate-400 transition-transform ${
                  ...
                  <div className="p-6 sm:p-8 pt-0 sm:pt-0 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div>
                          <label className="text-[10px] font-bold text-slate-400 capitalize tracking-wide mb-2.5 block">
                            Full Name
                          </label>
                          <input
                            disabled={!isEditing}
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <input
                                ...
                                className="w-full bg-slate-50 border border-slate-100 px-4 py-3.5 rounded-xl text-sm font-bold text-slate-900"
                              />
                            )}
                          </div>
                          <div>
                      ...
                      <div className="bg-slate-50/50 rounded-xl p-5 border border-slate-100 space-y-4">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h4 className="text-[10px] font-bold text-slate-400 capitalize tracking-wide">
                            Private Details
                          </h4>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-3.5 bg-white rounded-xl border border-slate-100 shadow-sm transition-transform hover:scale-[1.01]">
                            <div>
                              <label className="text-[9px] font-bold text-slate-300 capitalize tracking-tight block">
                                Email Address
                              </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
            {menuItems.map((item, id) => (
              ...
              >
                <div className="flex items-center gap-4 sm:gap-5">
                  <div
                    className={`p-3.5 sm:p-4 rounded-2xl bg-slate-50 ${item.color} group-hover:scale-110 transition-all duration-300 shadow-sm ring-1 ring-slate-100`}
                  >
                    {item.icon}
                  </div>
                  <div className="text-left">
                    <span className="font-bold text-slate-900 text-sm sm:text-base block tracking-tight group-hover:text-primary-600 transition-colors">
                      {item.label}
                    </span>
                    {item.description && (
