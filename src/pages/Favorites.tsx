              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                  ...
                  <button 
                    ...
                    className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/40 backdrop-blur-md flex items-center justify-center text-red-500 shadow-sm hover:bg-white transition-all cursor-pointer z-10"
                  >
                    <Heart className="w-4 h-4 fill-current" />
                  </button>
                  {listing.verified && (
                    <div className="absolute top-3 left-3 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center shadow-md border-2 border-white">
                ...
                <div className="p-4 sm:p-5 flex flex-col gap-2">
                  <h3 className="text-xs sm:text-sm font-bold text-slate-900 uppercase tracking-tight group-hover:text-primary-600 transition-colors truncate">
                    {listing.title}
                  </h3>
                  <div className="flex items-center gap-1.5 text-[10px] sm:text-xs text-slate-400 font-medium truncate">
