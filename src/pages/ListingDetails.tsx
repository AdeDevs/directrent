          ...
          <div className="pb-6 border-b border-slate-200 flex flex-col md:flex-row md:justify-between md:items-start gap-4">
           ...
           {listing.agent && (
              <div 
                ...
                className="md:hidden flex items-center justify-between bg-white p-4 rounded-2xl border border-slate-200 shadow-sm cursor-pointer active:opacity-75 transition-opacity"
              >
                <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="w-12 h-12 bg-primary-600 text-white rounded-xl shadow-lg shadow-primary-200 flex items-center justify-center hover:bg-primary-700 transition-colors cursor-pointer active:scale-95"
                >
        ...
        <div className="hidden md:block w-full md:w-[350px] flex-shrink-0">
          <div className="sticky top-24 flex flex-col gap-6 lg:gap-8">
            ...
            {listing.agent && (
              <div 
                onClick={() => setSelectedAgentId(listing.agent!.id!)}
                className="bg-slate-900 p-6 lg:p-8 rounded-3xl text-white shadow-xl relative overflow-hidden cursor-pointer hover:ring-2 hover:ring-primary-500/50 transition-all active:scale-[0.98]"
              >
